...
/**
  ...
  @namespace DS
*/
DS.JSONSerializer = Ember.Object.ext***REMOVED***({
  /**
...
/**
  ...
  @private
*/
DS.DebugAdapter = Ember.DataAdapter.ext***REMOVED***({
  getFilters: function() {
    return [
      { name: 'isNew', desc: 'New' },
...
/**
  ...
  @namespace DS
 */
DS.Transform = Ember.Object.ext***REMOVED***({
  /**
...
/**
  ...
  @namespace DS
 */
DS.BooleanTransform = DS.Transform.ext***REMOVED***({
  deserialize: function(serialized) {
...
/**
  ...
  @namespace DS
 */
DS.DateTransform = DS.Transform.ext***REMOVED***({
...
/**
  ...
  @namespace DS
 */
DS.NumberTransform = DS.Transform.ext***REMOVED***({
...
/**
  ...
  @namespace DS
 */
DS.StringTransform = DS.Transform.ext***REMOVED***({
...
DS.RecordArray = Ember.ArrayProxy.ext***REMOVED***(Ember.Evented, {
  /**
...
*/
DS.FilteredRecordArray = DS.RecordArray.ext***REMOVED***({
  /**
...
/**
  ...
  @ext***REMOVED***s DS.RecordArray
*/
DS.AdapterPopulatedRecordArray = DS.RecordArray.ext***REMOVED***({
  query: null,
...
***REMOVED***## Inverses
  ...
  @ext***REMOVED***s DS.RecordArray
*/
DS.ManyArray = DS.RecordArray.ext***REMOVED***({
  init: function() {
    this._super.apply(this, arguments);
...
*/
DS.Store = Ember.Object.ext***REMOVED***({
...
*/
DS.PromiseArray = Ember.ArrayProxy.ext***REMOVED***(Ember.PromiseProxyMixin);
/**
  ...
  @uses Ember.PromiseProxyMixin
*/
DS.PromiseObject = Ember.ObjectProxy.ext***REMOVED***(Ember.PromiseProxyMixin);
...
/**
  ...
  @uses Ember.Evented
 */
DS.Errors = Ember.Object.ext***REMOVED***(Ember.Enumerable, Ember.Evented, {
  /**
...
/**
  ...
  @uses Ember.Evented
*/
DS.Model = Ember.Object.ext***REMOVED***(Ember.Evented, {
  /**
...
/**
  ...
  @ext***REMOVED***s Ember.Object
*/
DS.RecordArrayManager = Ember.Object.ext***REMOVED***({
  init: function() {
...
DS.Adapter = Ember.Object.ext***REMOVED***({
...
*/
DS.FixtureAdapter = DS.Adapter.ext***REMOVED***({
...
*/
DS.RESTSerializer = DS.JSONSerializer.ext***REMOVED***({
  /**
...
***REMOVED***## Headers customization
  ...
  @ext***REMOVED***s DS.Adapter
*/
DS.RESTAdapter = DS.Adapter.ext***REMOVED***({
...
DS.ActiveModelSerializer = DS.RESTSerializer.ext***REMOVED***({
  // SERIALIZE
...
DS.ActiveModelAdapter = DS.RESTAdapter.ext***REMOVED***({
