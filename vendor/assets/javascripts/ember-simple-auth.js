...
*/
Ember.SimpleAuth.Session = Ember.ObjectProxy.ext***REMOVED***({
  /**
  ...
  */
  ...
  /**
    ...
    @param {Object} options The options to pass to the authenticator; dep***REMOVED***ing on the type of authenticator these might be a set of credentials etc.
...
*/
Ember.SimpleAuth.Authorizers.Base = Ember.Object.ext***REMOVED***({
  /**
...
/**
  ...
  @class OAuth2
  @namespace Ember.SimpleAuth.Authorizers
  @ext***REMOVED***s Ember.SimpleAuth.Authorizers.Base
*/
Ember.SimpleAuth.Authorizers.OAuth2 = Ember.SimpleAuth.Authorizers.Base.ext***REMOVED***({
  /**
...
/**
  ...
  @uses Ember.Evented
*/
Ember.SimpleAuth.Authenticators.Base = Ember.Object.ext***REMOVED***(Ember.Evented, {
  /**
  ...
  */
  ...
  /**
    ...
    dep***REMOVED***ing on the actual authentication mechanism the authenticator uses
...
/**
  ...
  @class OAuth2
  @namespace Ember.SimpleAuth.Authenticators
  @ext***REMOVED***s Ember.SimpleAuth.Authenticators.Base
*/
Ember.SimpleAuth.Authenticators.OAuth2 = Ember.SimpleAuth.Authenticators.Base.ext***REMOVED***({
  /**
...
Ember.SimpleAuth.Authenticators.Devise = Ember.SimpleAuth.Authenticators.Base.ext***REMOVED***({
  /**
    The ***REMOVED***point on the server the authenticator acquires the access token
    from.
  ...
  */
  ...
  /**
    ...
    @method makeRequest
    @param {Object} data The data to s***REMOVED*** with the request, e.g. email and password or the refresh token
    @return {Ember.RSVP.Promise} A promise that resolves when an access token is successfully acquired from the server and rejects otherwise
    @protected
  */
  makeRequest: function(data, resolve, reject) {
    return Ember.$.ajax({
      ...
      return Ember.run(function() {
        return resolve(Ember.$.ext***REMOVED***(response, {
...
/**
  ...
  @uses Ember.Evented
*/
Ember.SimpleAuth.Stores.Base = Ember.Object.ext***REMOVED***(Ember.Evented, {
  /**
...
/**
  ...
  @class Cookie
  @namespace Ember.SimpleAuth.Stores
  @ext***REMOVED***s Ember.SimpleAuth.Stores.Base
*/
Ember.SimpleAuth.Stores.Cookie = Ember.SimpleAuth.Stores.Base.ext***REMOVED***({
  /**
...
/**
  ...
  @ext***REMOVED***s Ember.SimpleAuth.Stores.Base
*/
Ember.SimpleAuth.Stores.Ephemeral = Ember.SimpleAuth.Stores.Base.ext***REMOVED***({
  /**
    @method init
    @private
  */
  ...
  */
  persist: function(properties) {
    this._data = Ember.$.ext***REMOVED***(properties, this._data);
  },
...
/**
  ...
  @ext***REMOVED***s Ember.SimpleAuth.Stores.Base
*/
Ember.SimpleAuth.Stores.LocalStorage = Ember.SimpleAuth.Stores.Base.ext***REMOVED***({
  /**
  ...
  actions: {
    ...
    */
    ...
    /**
      ...
      arguments the action is invoked with dep***REMOVED*** on the used authenticator
      (see
      [Ember.SimpleAuth.Authenticators.Base](#Ember-SimpleAuth-Authenticators-Base)).
