...
***REMOVED*** Configure static asset server for tests with Cache-Control for performance.
...
***REMOVED*** Raise exceptions instead of r***REMOVED***ering exception templates.
